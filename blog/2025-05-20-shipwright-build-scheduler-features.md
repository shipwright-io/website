...
slug: shipwright-build-scheduler-features
authors: [dorzel]
tags: [shipwright, scheduling, multi-arch]
---

## New Build Scheduler Features

A new set of build scheduling features introduced in [v0.15](/blog/shipwright-v0.15-is-here) allows users to specify node selectors, custom schedulers, and tolerations for builds.
