...
slug: introducing-shipwright-beta-api
authors: [qu1queee]
tags: [shipwright, api, beta]
---

About a year ago, we published a blog [post](/blog/bringing-shipwright-to-beta-and-beyond)
...
| BuildRun | `.spec.sources`                  | `.spec.source` only for `Local`        |
