...
slug: shipwright-v0.10.0-is-here
authors: [saschaschwarze0]
tags: [shipwright, release]
---

Just before [cdCon 2022](https://cd.foundation/event/cdcon-2022/), we are releasing our v0.10 release. But before we look into it, we would like to invite you to join our cdCon sessions. We'll have two interesting presentations and a summit where you can bring every feedback and suggestion that you would like to share with us, and bring all your questions that you want to get answered. See [our blog post](/blog/upcoming-shipwright-community-summit) for more information. See you in Austin or in the virtual space.
